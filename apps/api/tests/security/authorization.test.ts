...
const ROUTES: RouteCase[] = [
  ...
  { method: 'GET', path: '/api/v1/auth/providers', access: 'public' },
  {
    ...
    access: 'public',
    payload: { username: 'nobody', password: 'nobody-password' },
    allow401: true,
  },
  ...
  // Day-to-day changes.
  {
    ...
    path: '/api/v1/sites',
    access: 'operator',
    payload: { name: 'Site', parentId: null },
  },
  {
    method: 'PATCH',
  ...
  {
    method: 'POST',
    path: '/api/v1/polling-profiles',
    access: 'operator',
    payload: VALID.pollingProfile,
  },
  {
    method: 'PATCH',
    path: `/api/v1/polling-profiles/${uuid}`,
    access: 'operator',
    payload: { name: 'Renamed' },
  },
  ...
  {
    method: 'POST',
    path: '/api/v1/alerts/contact-points',
    access: 'operator',
    payload: VALID.contactPoint,
  },
  {
    method: 'PUT',
    path: `/api/v1/alerts/contact-points/${uuid}`,
    access: 'operator',
    payload: VALID.contactPoint,
  },
  ...
  {
    method: 'PUT',
    path: '/api/v1/storage/policy',
    access: 'administrator',
    payload: VALID.storagePolicy,
  },
  ...
  {
    method: 'POST',
    path: `/api/v1/users/${uuid}/password`,
    access: 'administrator',
  ...
  {
    method: 'POST',
    path: '/api/v1/credentials/snmp',
    access: 'administrator',
    payload: VALID.credential,
  },
  {
    method: 'PATCH',
    path: `/api/v1/credentials/snmp/${uuid}`,
    access: 'administrator',
    payload: { name: 'Renamed' },
  },
